package app.duss.kcommerce.ui.kcommerce.components
...
import app.duss.kcommerce.ui.helper.LocalSafeArea
import app.duss.kcommerce.ui.kcommerce.PokedexComponent
import app.duss.kcommerce.ui.kcommerce.store.KCommerceStore
import app.duss.kcommerce.ui.theme.*

@OptIn(ExperimentalMaterial3Api::class)
@Composable
internal fun KCommerceContent(
    state: KCommerceStore.State,
    onEvent: (KCommerceStore.Intent) -> Unit,
            ...
            Column {
                ...
                PokemonGrid(
                    ...
                    loadMoreItems = {
                        ...
                        onEvent(KCommerceStore.Intent.LoadPokemonListByPage(page = nextPage))
                    }
                )
            }
